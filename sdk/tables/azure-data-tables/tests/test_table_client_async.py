...
class StorageTableClientTest(TableTestCase):
    ...
    @TablesPreparer()
    async def test_create_service_with_key_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_async(self, tables_storage_account_name, tables_primary_storage_account_key):
    ...
    @TablesPreparer()
    async def test_create_service_with_sas_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_token_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        url = self.account_url(tables_storage_account_name, "table")
        suffix = '.table.core.windows.net'
        for service_type in SERVICES:
            # Act
    ...
    @TablesPreparer()
    async def test_create_service_with_token_and_http_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        for service_type in SERVICES:
            # Act
    ...
    @TablesPreparer()
    async def test_create_service_china_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_protocol_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_empty_key_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_socket_timeout_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_key_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_sas_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_cosmos_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_endpoint_protocol_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_emulated_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for service_type in SERVICES.items():
    ...
    @TablesPreparer()
    async def test_create_service_with_connection_string_custom_domain_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for service_type in SERVICES.items():
    ...
    @TablesPreparer()
    async def test_create_service_with_conn_str_custom_domain_trailing_slash_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for service_type in SERVICES.items():
            conn_string = 'AccountName={};AccountKey={};TableEndpoint=www.mydomain.com/;'.format(
                tables_storage_account_name, tables_primary_storage_account_key)
    ...
    @TablesPreparer()
    async def test_create_service_with_conn_str_custom_domain_sec_override_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for service_type in SERVICES.items():
            conn_string = 'AccountName={};AccountKey={};TableEndpoint=www.mydomain.com/;'.format(
                tables_storage_account_name, tables_primary_storage_account_key)
    ...
    @TablesPreparer()
    async def test_create_service_with_conn_str_fails_if_sec_without_primary_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        for service_type in SERVICES.items():
            # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_conn_str_succeeds_if_sec_with_primary_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        for service_type in SERVICES.items():
            # Arrange
    ...
    @TablesPreparer()
    async def test_create_service_with_custom_account_endpoint_path_async(self, tables_storage_account_name, tables_primary_storage_account_key):
    ...
    @TablesPreparer()
    async def test_create_table_client_with_complete_table_url_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_create_table_client_with_complete_url_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
    ...
    @TablesPreparer()
    async def test_closing_pipeline_client_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for client, url in SERVICES.items():
            # Act
            service = client(
    ...
    @TablesPreparer()
    async def test_closing_pipeline_client_simple_async(self, tables_storage_account_name, tables_primary_storage_account_key):
        # Arrange
        for client, url in SERVICES.items():
            # Act
            service = client(
